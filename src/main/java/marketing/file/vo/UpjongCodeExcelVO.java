...
public class UpjongCodeExcelVO {
	...
	public String toString() {
		return "UpjongCodeExcelVO [indsLclsCd=" + indsLclsCd + ", indsLclsNm=" + indsLclsNm + ", indsMclsCd="
				+ indsMclsCd + ", indsMclsNm=" + indsMclsNm + ", indsSclsCd=" + indsSclsCd + ", indsSclsNm="
				+ indsSclsNm + "]";
	}
}
